        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mx-auto grid w-[350px] gap-6">
          ...
          <div className="grid gap-4">
            ...
            <div className="grid gap-2">
              ...
              <Input id="password" type="password" required className="rounded-[3px]" {...register("password")}/>
            </div>
            <Button type="submit" className="w-full bg-white text-black hover:text-white rounded-[3px]">
              Login
            </Button>
          </div>
